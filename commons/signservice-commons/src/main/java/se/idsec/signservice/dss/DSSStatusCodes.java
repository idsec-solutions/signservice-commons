...
public class DSSStatusCodes {
  ...
  public static final String DSS_MINOR_REQUESTER_ERROR_REQUEST_EXPIRED = "http://id.elegnamnden.se/sig-status/1.0/req-expired";

  /** Sweden Connect extension. The authenticated user does not match the signer identity attributes in the request. */
  public static final String DSS_MINOR_REQUESTER_ERROR_USER_MISMATCH = "http://id.elegnamnden.se/sig-status/1.0/user-mismatch";

  /** Sweden Connect extension. The requested level of assurance for user authentication is not supported. */
  public static final String DSS_MINOR_REQUESTER_ERROR_UNSUPPORTED_LOA = "http://id.elegnamnden.se/sig-status/1.0/unsupported-loa";
  ...
  public static final String DSS_MINOR_REQUESTER_ERROR_KEY_INFO_NOT_PROVIDED = "urn:oasis:names:tc:dss:1.0:resultminor:KeyInfoNotProvided";
  ...
  public static final String DSS_MINOR_REQUESTER_INVALID_REFURI = "urn:oasis:names:tc:dss:1.0:resultminor:InvalidRefURI";
   ...
   */
  public static final String DSS_MINOR_REQUESTER_INAPPROPRIATE_SIGNATURE = "urn:oasis:names:tc:dss:1.0:resultminor:Inappropriate:signature";
   ...
   */
  public static final String DSS_MINOR_RESPONDER_ERROR_SIGMESSAGE_ERROR = "http://id.elegnamnden.se/sig-status/1.0/sigmessage-error";
   ...
   */
  public static final String DSS_MINOR_RESPONDER_ERROR_GENERAL_ERROR = "urn:oasis:names:tc:dss:1.0:resultminor:GeneralError";

  /** Locating the identified key failed (e.g. look up failed in directory or in local key file). */
  public static final String DSS_MINOR_RESPONDER_ERROR_KEY_LOOKUP_FAILED = "urn:oasis:names:tc:dss:1.0:resultminor:invalid:KeyLookupFailed";

  /** The request could not be satisfied due to insufficient information. */
  public static final String DSS_INSUFFICIENT_INFORMATION = "urn:oasis:names:tc:dss:1.0:resultmajor:InsufficientInformation";
